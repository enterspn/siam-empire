...
const STUDENT_ROUTES = ["/dashboard", "/trade", "/war", "/news", "/city-info", "/missions", "/laws", "/envoy", "/waiting"];
...
export const config = {
  matcher: ["/dashboard/:path*", "/trade/:path*", "/war/:path*", "/news/:path*", "/city-info/:path*", "/missions/:path*", "/laws/:path*", "/envoy/:path*", "/waiting/:path*", "/admin/:path*"],
};
